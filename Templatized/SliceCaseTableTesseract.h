...
#ifndef VISUALIZATION_TEMPLATIZED_SLICECASETABLETESSERACT_INCLUDED
#define VISUALIZATION_TEMPLATIZED_SLICECASETABLETESSERACT_INCLUDED
...
template <>
class SliceCaseTable<Tesseract<3> >
	{
	/* Embedded classes: */
	public:
