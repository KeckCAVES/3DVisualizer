...
#ifndef VISUALIZATION_TEMPLATIZED_MULTICURVILINEARGRIDRENDERER_INCLUDED
#define VISUALIZATION_TEMPLATIZED_MULTICURVILINEARGRIDRENDERER_INCLUDED
...
class MultiCurvilinearGridRenderer
	{
	/* Embedded classes: */
	public:
	...
	public:
	MultiCurvilinearGridRenderer(const DataSet* sDataSet); // Creates a renderer for the given data set
