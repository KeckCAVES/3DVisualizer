...
#ifndef VISUALIZATION_TEMPLATIZED_SLICECASETABLESIMPLEX_INCLUDED
#define VISUALIZATION_TEMPLATIZED_SLICECASETABLESIMPLEX_INCLUDED
...
template <>
class SliceCaseTable<Simplex<3> >
	{
	/* Embedded classes: */
	public:
