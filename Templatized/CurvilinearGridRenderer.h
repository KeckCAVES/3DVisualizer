...
#ifndef VISUALIZATION_TEMPLATIZED_CURVILINEARGRIDRENDERER_INCLUDED
#define VISUALIZATION_TEMPLATIZED_CURVILINEARGRIDRENDERER_INCLUDED
...
class CurvilinearGridRenderer
	...
	public:
	CurvilinearGridRenderer(const DataSet* sDataSet); // Creates a renderer for the given data set
