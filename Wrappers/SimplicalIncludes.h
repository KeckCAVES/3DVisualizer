/***********************************************************************
SimplicalIncludes - Includes header files required by visualization
modules representing simplical data sets.
...
#ifndef VISUALIZATION_WRAPPERS_SIMPLICALINCLUDES_INCLUDED
#define VISUALIZATION_WRAPPERS_SIMPLICALINCLUDES_INCLUDED
