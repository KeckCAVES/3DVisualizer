...
Visualization::Abstract::DataSet* CitcomSGlobalASCIIFile::load(const std::vector<std::string>& args,Comm::MulticastPipe* pipe) const
	{
	...
	if(numSurfaces==0||numCpus.calcIncrement(-1)==0||numVertices.calcIncrement(-1)==0)
		Misc::throwStdErr("CitcomSGlobalASCIIFile::load: %s is not a valid CitcomS configuration file",argIt->c_str());
