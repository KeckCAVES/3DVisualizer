...
#ifndef VISUALIZATION_CONCRETE_SCTFILE_INCLUDED
#define VISUALIZATION_CONCRETE_SCTFILE_INCLUDED
...
class SCTFile:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	SCTFile(void); // Default constructor
