...
class Visualizer:public Vrui::Application
	...
	#ifdef VISUALIZER_USE_COLLABORATION
	friend class Collaboration::SharedVisualizationClient;
	#endif
	...
	Collaboration::SharedVisualizationClient* sharedVisualizationClient; // Protocol plug-in for shared Visualizer protocol
	#endif
